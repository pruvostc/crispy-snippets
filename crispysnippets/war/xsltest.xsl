...
<xsl:output version="1.0" encoding="UTF-8" indent="no" media-type="text/html" method="html"/>
...
<div data-role="page" id="pageone" style="width: 100%; overflow: auto">
  <div data-role="header">
   ...
   <form>
      <input id="filterTable-input" data-type="search" placeholder="Basic search For text..."/>
    </form>
   <table data-role="table" data-mode="columntoggle" class="ui-responsive" data-column-btn-text="Columns..." id="myTable" data-filter="true" data-input="#filterTable-input">
    <thead>
    <tr bgcolor="#9acd32">
    ...
    <tr>
     ...
     <td><xsl:value-of select="md:Organization/md:OrganizationName"/></td>
     <td><xsl:value-of select="md:Organization/md:OrganizationDisplayName"/></td>
...
<a href="#popUIInfo{$position}" data-rel="popup" class="ui-btn ui-corner-all ui-shadow ui-btn-inline">mdui:UIInfo</a>
<div data-role="popup" id="popUIInfo{$position}" class="ui-content" style="max-width:800px">
...
<xsl:if test="child::md:IDPSSODescriptor/md:Extensions/saml1md:Scope != '' or child::md:SPSSODescriptor/md:Extensions/saml1md:Scope != ''">
<a href="#Scope{$position}" data-rel="popup" class="ui-btn ui-corner-all ui-shadow ui-btn-inline" style="background:#57FF57;">saml1md:Scope</a>
<div data-role="popup" id="Scope{$position}" class="ui-content" style="max-width:800px">
    <a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-z ui-icon-delete ui-btn-icon-notext ui-btn-right">Close</a>
	<xsl:if test="child::md:SPSSODescriptor/md:Extensions/saml1md:Scope or child::md:IDPSSODescriptor/md:Extensions/saml1md:Scope">
	<ol class="mduiHeader">saml1md:Scope
	<xsl:for-each select="*/md:Extensions/saml1md:Scope">
	<li class="uiinfo"><xsl:value-of select="."/></li>
	</xsl:for-each>
	</ol></xsl:if>
</div>
